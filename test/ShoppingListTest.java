...
//
//    BuildReceiptsTest(shoppingList.getGoodItem("ITEM000001").getAmount(), 8);
//    BuildReceiptsTest("ITEM000001", shoppingList.getGoodItem("ITEM000001").getGoods().getBarcode());
//    BuildReceiptsTest("可口可乐", shoppingList.getGoodItem("ITEM000001").getGoods().getName());
//    BuildReceiptsTest("3.00", shoppingList.getGoodItem("ITEM000001").getGoods().getPrice());
//  }
//
//  @Test
...
//    shoppingList.addGoodsItem(goodsItem2);
//
//    BuildReceiptsTest("ITEM000001", shoppingList.getIdList().get(0));
//    BuildReceiptsTest(shoppingList.getIdList().get(1), "ITEM000002");
//  }
//  @Test
...
//
//    BuildReceiptsTest(arrayList.get(0), "ITEM000001");
//    BuildReceiptsTest(arrayList.get(1), "ITEM000002");
//  }
//}
